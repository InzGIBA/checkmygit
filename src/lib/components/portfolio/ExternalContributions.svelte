		...
		<div class="flex items-center gap-3 text-xs text-text-tertiary">
			...
			<span class="flex shrink-0 items-center gap-1 whitespace-nowrap">
				<svg class="h-4 w-4 text-accent-purple" fill="currentColor" viewBox="0 0 16 16">
					<path
						d="M10.5 7.75a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm1.43.75a4.002 4.002 0 0 1-7.86 0H.75a.75.75 0 0 1 0-1.5h3.32a4.002 4.002 0 0 1 7.86 0h3.32a.75.75 0 0 1 0 1.5Zm-1.43-.75a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0Z"
					/>
				</svg>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		{#each topContributions as contrib (contrib.repoName)}
			<a
				...
				class="group block rounded-md border border-border-default bg-bg-secondary p-4 transition-all hover:border-border-subtle hover:bg-bg-tertiary"
			>
				<!-- Header -->
				<div class="mb-2 flex items-start justify-between">
					<div class="flex items-center gap-2">
						<svg class="h-4 w-4 text-text-tertiary" fill="currentColor" viewBox="0 0 16 16">
							<path
				...
				<div class="flex items-center gap-4 text-xs text-text-tertiary">
					...
					{#if contrib.commitCount > 0}
						<div class="flex items-center gap-1">
							<svg class="h-4 w-4 text-accent-purple" fill="currentColor" viewBox="0 0 16 16">
								<path
									d="M10.5 7.75a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm1.43.75a4.002 4.002 0 0 1-7.86 0H.75a.75.75 0 0 1 0-1.5h3.32a4.002 4.002 0 0 1 7.86 0h3.32a.75.75 0 0 1 0 1.5Z"
								/>
							</svg>
